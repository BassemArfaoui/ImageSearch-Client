      ...
      <div className="search-area border-2 bg-white border-gray-500 p-4 w-full rounded-2xl md:w-200 shadow-lg shadow-gray-200">
        <div className="search-box ">
          ...
          <div className="flex justify-between mt-6 items-center">
            <span className="rounded-full border-2 p-1 flex justify-center items-center border-gray-600 cursor hover:outline-4 hover:outline-gray-200" >
              <IoMdAdd className="size-6 text-gray-600" />
            </span>
            <span className="rounded-full border-2 p-1 flex justify-center items-center border-gray-600 ">
