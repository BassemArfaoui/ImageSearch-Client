export default function CardsLoading() {
    return (
      <div className="w-[200px] overflow-hidden rounded-xl border-2 border-gray-400 bg-white shadow-lg transition-all animate-pulse">
        ...
        {/* Footer Skeleton */}
        <div className="flex items-center justify-between border-t p-3 px-4 pt-2 flex-col gap-2">
